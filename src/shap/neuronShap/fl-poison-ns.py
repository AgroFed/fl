...
from libs import agg, data, fl, log, nn, poison, resnet, sim, wandb, neuronshap as ns
...
model = global_model  # Replace YourModel() with your actual PyTorch model
dataset = test_data  # Replace YourDataset() with your actual dataset

dataset1 = data.split_data(dataset, [i for i in range(10000)])[0]
#print(dataset1)
shapley_values = ns.calculate_shapley_values_mcp(model, dataset1)
