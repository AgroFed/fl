...
class FedArgs():
    def __init__(self):
        ...
        self.tb = SummaryWriter('../../../out/runs/federated/FLTrust/cf-sine-10-dot-2 (proxy)', comment="Centralized Federated training")
...
cosine_attack = True
cosargs = {"poison_percent": 1, "scale_dot": 2, "scale_norm": 10}
