...
train_data, test_data = data.load_dataset(fedargs.dataset, True)
...
for epoch in tqdm(range(fedargs.epochs)):
    ...
    if epoch > 0:
        ...
        if backdoor_attack["is"]:
            ...
            wb.log({"epoch": epoch, "time": time.time(), "backdoor_misclassification_rate": backdoor_test_output["misclass"]})
